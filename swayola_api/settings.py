"""
Django settings for swayola_api project.
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "swayola_api.urls.api_exception_handler",
}
...
WSGI_APPLICATION = 'swayola_api.wsgi.application'
...
CELERY_RESULT_BACKEND = os.getenv('CELERY_RESULT_BACKEND'), # Redis URL
